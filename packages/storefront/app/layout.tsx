...
export const metadata: Metadata = {
  title: {
    default: `${SITE_BRAND.fullName} — ${SITE_BRAND.tagline}`,
    template: `%s | ${SITE_BRAND.shortName}`,
  },
  description: SITE_BRAND.description,
  openGraph: {
    type: 'website',
    siteName: SITE_BRAND.fullName,
    title: `${SITE_BRAND.fullName} — запчасти по VIN и каталогу`,
    description: SITE_BRAND.description,
  },
};
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <meta name="generator" content={`${SITE_BRAND.fullName}`} />
