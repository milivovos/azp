          ...
          <div>
            ...
            <form className="mt-3 flex gap-2">
              <input
                ...
                className="h-11 min-h-[44px] flex-1 rounded-md border border-gray-200 px-3 text-sm outline-none focus:border-primary focus:ring-2 focus:ring-primary/50"
              />
              <button
                type="submit"
